...
- `assumption-mapping` - Surface and prioritize risky assumptions in product ideas before building.
- `backlog-grooming` - Sprint-ready backlog refinement, estimation, and zombie-story cleanup.
...
- `content-quality-editor` - Strip AI writing patterns and apply a final quality pass before publishing.
- `customer-success-manager` - Translate engineering behavior into customer-impact guidance.
- `growth-loops` - Growth loop design, PLG mechanics, and constraint analysis for compounding acquisition.
